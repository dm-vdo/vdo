...
{
	log_info("  slab journal: entry_waiters=%zu waiting_to_commit=%s" " updating_slab_summary=%s head=%" PRIu64 " unreapable=%" PRIu64 " tail=%" PRIu64 " next_commit=%" PRIu64 " summarized=%" PRIu64 " last_summarized=%" PRIu64 " recovery_lock=%" PRIu64 " dirty=%s",
