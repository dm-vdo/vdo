 ...
 * 02110-1301, USA. 
 *
 * $Id: //eng/linux-vdo/src/c++/vdo/base/slabDepotFormat.c#6 $
 */
			 ...
			 struct slab_depot_state_2_0 *state)
{
	...
	logDebug("slabDepot configure_slab_depot(block_count=%" PRIu64 ", first_block=%" PRIu64 ", slab_size=%" PRIu64 ", zone_count=%u)",
		 block_count,
		 first_block,
		 slab_size,
		 zone_count);
