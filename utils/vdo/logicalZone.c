...
void dump_logical_zone(const struct logical_zone *zone)
{
	...
	log_info("  flush_generation=%" PRIu64 " oldest_active_generation=%" PRIu64 " oldest_locked_generation=%" PRIu64 " notification_generation=%" PRIu64 " notifying=%s ios_in_flush_generation=%" PRIu64,
