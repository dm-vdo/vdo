 ...
 * 02110-1301, USA. 
 *
 * $Id: //eng/uds-releases/krusty/src/uds/chapterIndex.c#11 $
 */
				 ...
				 unsigned int *num_lists)
{
	...
	if (removals > 0) {
		log_warning("To avoid chapter index page overflow in chapter %" PRIu64 ", %u entries were removed from the chapter index",
			    open_chapter_index->virtual_chapter_number,
			    removals);
	}
	return UDS_SUCCESS;
